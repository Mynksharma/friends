...
.intro ul li{padding:5px;}
    ...
    <div class="cont-center"><div class="conback"><div style="position:relative;height:87%;width:100%;">
      <img src="uploads/waterfall.jpg" width="100%" height="100%"/>
		...
		<button  style="position:absolute;bottom:10px;right:20px;" type="button" class="btn btn-danger"><b>Activity log </b>
		<span class="badge">7</span></button> <div class="thumbnail thu">
<?php if($gender=="Male"){?><img src="uploads/default.png" alt="profile" style="height:100%;width:auto;" />
	<?php }else{?><img src="uploads/defaultf.png" alt="profile" style="height:100%;width:auto;"/><?php } ?></div></div>
		...
		<div class="intro"><div class="jumbotron" style="margin:2px;border-radius:4px;text-align:center;font-size:20px;padding:5px;">
		<i class="fa fa-globe" style="color:Blue;font-size:30px"></i>
		 <b style="vertical-align:text-bottom;">Intro</b></div>
		<div class="container" style="text-align:center;width:100%;"><p><br><b>Add a short bio to tell people more about yourself</b>
		<br>
		<i class="glyphicon glyphicon-edit" style=""></i><a href="about.php">  Add Bio</a></p><hr><div>
